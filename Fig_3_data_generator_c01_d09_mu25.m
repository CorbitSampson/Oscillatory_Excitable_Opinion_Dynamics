%% preamble
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This code generates the data that is plotted in Fig.3 for c=0.1, d=0.9, and
...
writematrix(diff_meanfield, 'ab_param_sweep_MF_c01_d09_mu25.txt')
writematrix(diff_sim, 'ab_param_sweep_SIM_c01_d09_mu25.txt')
