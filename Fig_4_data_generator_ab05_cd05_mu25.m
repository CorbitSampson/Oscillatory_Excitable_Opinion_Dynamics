%% preamble
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This code generates the data that is plotted in Fig.4 for a=b=0.5, c=d=0.5 and
...
writematrix(diff_meanfield, 'm_param_sweep_MF_a05_b05_c05_d05_mu25.txt')
writematrix(diff_sim, 'm_param_sweep_SIM_a05_b05_c05_d05_mu25.txt')
