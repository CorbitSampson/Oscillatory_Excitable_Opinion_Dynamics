...
%% preamble
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This code generates the data that is plotted in Fig.4 for a=b=0.8, c=d=0.2 and
...
writematrix(diff_meanfield, 'm_param_sweep_MF_a08_b08_c02_d02_mu25.txt')
writematrix(diff_sim, 'm_param_sweep_SIM_a08_b08_c02_d02_mu25.txt')
